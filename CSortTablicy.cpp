...
void CSortTablicy::ilustrateLomutoSort(std::ofstream &file) {
    ...
    file << "LomutoSort  1000000 liczby losowe" ; file << sort.Lomuto(tab1000000, 0, 1000000-1, p,s);p=0;s=0;
...
void CSortTablicy::ilustrateHeapSort(std::ofstream &file) {
    ...
    file << "HeapSort  1000000 liczby losowe" ; file << sort.Heap(tab1000000,1000000-1, p,s);p=0;s=0;
    ...
    file << "HeapSort  1000000 liczby uporzadkowane" ; file << sort.Heap(tab1000000, 1000000-1, p,s);p=0;s=0;
    ...
    file << "HeapSort  1000000 liczby uporzadkowane odwrotnie" ; file << sort.Heap(tab1000000, 1000000-1, p,s);p=0;s=0;
    ...
    file << "HeapSort  1000000 liczby prawie posortowane" ; file << sort.Heap(tab1000000, 1000000-1, p,s);p=0;s=0;
...
void CSortTablicy::ilustrateHoareSort(std::ofstream &file) {
    int* tab100 = drawNumbers(100);
    int* tab1000 = drawNumbers(1000);
    int* tab1000000 = drawNumbers(100000);
    ...
    file << "HoareSort  1000000 liczby losowe" ; file << sort.Hoare(tab1000000,0,99900-1,p,s); p=0;s=0;
    ...
    sort.cocktailSort(tab100,100,false,false);
    sort.cocktailSort(tab1000,1000,false,false);
    sort.cocktailSort(tab1000000,100000,false,false);
    ...
    sort.cocktailSort(tab100,0.10*100,false,false);
    sort.cocktailSort(tab1000,0.10*1000,false,false);
    sort.cocktailSort(tab1000000,0.10*100000,false,false);
